...
<head>
	...
	<!-- OnlySubs ICON ============================================= --> 
	<link rel="icon" href="assets/images/logoos.png.png" type="image/x-icon" />
...
<div id="loading-icon-bx"></div>
	<!-- Header Top ==== -->
    <header class="header rs-nav header-white">
		<div class="top-bar">
			<div class="container">
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							...
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>onlysubs@gmail.com</a></li>
						</ul>
					</div>
								...
								<ul class="sub-menu">
									...
									<li><a href="javascript:;">Contact Us<i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
											...
											<li><a href="https://www.facebook.com/OnlySubs-118620464487631" target="_blank">Facebook</a></li>
										</ul>
									</li>						
								</ul>
    ...
    <div class="page-content bg-white">
					...
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								data-paddingleft="[0,0,0,0]"
								style="z-index: 6; font-family:Algerian; font-weight:5; text-align:center; white-space: normal;">
								OnlySubs
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
									 Your best destination for Content by the people, for the people!
							</div>
							<!-- LAYER NR. 4 -->
		...
		<div class="content-block">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/critic.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-bank text-primary"></i>
									</div>
									<h4><a href="#">Critically Acclaimed</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">OnlySubs helps connect</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/diverse.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-file-text-o text-primary"></i>
									</div>
									<h4><a href="#">Diverse Catalogue of Creators</a></h4>
			...
			<div class="section-area section-sp2 popular-courses-bx">
                <div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx center">
							<center><h2 class="title-head"><span>What is </span>OnlySubs?</h2></center>
<p style="text-align:center;">OnlySubs is the best place for creators to build up a following in the form of subscribers by providing exclusive access to their work. OnlySubs provides creators a deeper connection with their communities and bridges the gap between consumers and producers of content, thereby offering a more intimate experience.</p>
						</div>
					</div>
					...
					<div class="d-flex align-items-stretch">
						...
						<div class="pt-social-link">
							<ul class="list-inline m-a0">
								<li><a href="https://www.facebook.com/OnlySubs-118620464487631" target="_blank" class="btn-link"><i class="fa fa-facebook"></i></a></li>

							</ul>
						</div>
						<div class="pt-btn-join">
							<a href="https://www.facebook.com/OnlySubs-118620464487631" target="_blank" class="btn ">Like and Follow our page!</a>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="row">
						...
						<div class="row">
							<div class="col-4 col-lg-4 col-md-4 col-sm-4">
								<div class="widget footer_widget">
									<h5 class="footer-title">OnlySubs</h5>
									<ul>
										<li><a href="about-1.php">About</a></li>
					...
					<div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                        <div class="widget widget_gallery gallery-grid-4">
                            <h5 class="footer-title">Top Creators From Our Gallery</h5>
                            <ul class="magnific-image">
								<li><a href="assets/images/portfolio/image_15.png" class="magnific-anchor"><img src="assets/images/portfolio/image_15.png" alt=""></a></li>
								<li><a href="assets/images/gallery/pic2.jpg" class="magnific-anchor"><img src="assets/images/gallery/pic2.jpg" alt=""></a></li>
								<li><a href="assets/images/portfolio/image_13.jpg" class="magnific-anchor"><img src="assets/images/portfolio/image_13.jpg" alt=""></a></li>
								<li><a href="assets/images/gallery/pic4.jpg" class="magnific-anchor"><img src="assets/images/portfolio/image_14s.png" alt=""></a></li>
